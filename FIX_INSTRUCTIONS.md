# FIX DATABASE - HERO CARDS TABLE

## Cara 1: Via Browser (RECOMMENDED)
Buka browser dan akses:
http://localhost/lending_word/fix_database.php

## Cara 2: Via HeidiSQL / pgAdmin
Copy dan paste SQL berikut ke Query Tool:

```sql
-- Step 1: Rename carousel images table if exists
DO $$ 
BEGIN
...
Kemudian klik Execute/Run.

## Setelah selesai:
Refresh halaman specification.php dan error akan hilang.
