-- Update konten ke tema Porsche
-- Jalankan di pgAdmin atau psql setelah connect ke database landing_cms
...
-- Cek hasil
SELECT section, key_name, value FROM content ORDER BY section, key_name;
